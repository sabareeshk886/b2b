    ...
    return (
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    { label: 'Total Bookings', value: '0', icon: Package, color: 'text-blue-600 bg-blue-50' },
                    { label: 'Confirmed', value: '0', icon: Calendar, color: 'text-[#006A4E] bg-emerald-50' },
                    { label: 'Pending', value: '0', icon: Clock, color: 'text-orange-600 bg-orange-50' },
                    { label: 'Total PAX', value: '0', icon: Users, color: 'text-purple-600 bg-purple-50' },
                ].map((stat, idx) => (
                ...
                <div className="space-y-6">
                    {bookings.length > 0 ? (
                        ...
                        <div className="py-12 text-center border border-[#EBEBEB] rounded-2xl bg-gray-50/50">
                            ...
                            <h3 className="text-lg font-bold text-[#222222] mb-1">No Active Bookings</h3>
                            <p className="text-sm font-medium text-gray-500 max-w-sm mx-auto">When your clients confirm their trips, their active bookings will appear here.</p>
                        </div>
                    )}
                </div>
            </div>
