    ...
    return (
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    { label: 'Total Quotes', value: '0', icon: FileText, color: 'text-blue-600 bg-blue-50' },
                    { label: 'Confirmed', value: '0', icon: Users, color: 'text-[#006A4E] bg-emerald-50' },
                    { label: 'Total Value', value: '₹0', icon: DollarSign, color: 'text-orange-600 bg-orange-50' },
                    { label: 'Pending', value: '0', icon: Clock, color: 'text-purple-600 bg-purple-50' },
                ].map((stat, idx) => (
